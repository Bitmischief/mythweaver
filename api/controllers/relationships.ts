...
export default class RelationshipController {
  ...
  public async getRelationships(
    ...
    return getRelationshipsData(userId, type, nodeId, filterTypes, depthLimit);
  }
  ...
  public async postRelationship(
    ...
    await createRelationship(userId, type, nodeId, body);
  }
  ...
  public async deleteRelationship(
    ...
    await deleteRelationshipById(userId, relationshipId, logger);
  }
  ...
  public async deleteRelationshipByNodeIds(
    ...
    await deleteRelationshipByNodeIds(userId, relationshipData, logger);
  }
  ...
  public async patchRelationship(
    ...
    await updateRelationship(userId, relationshipId, request, logger);
  }
  ...
  public async getRelationshipGraph(
    ...
    return getRelationshipGraphData(userId, campaignId, logger);
  }
}

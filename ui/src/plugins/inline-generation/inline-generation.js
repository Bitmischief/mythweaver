import { postGenerateArbitraryReplacement } from '@/api/generators';
import { showError } from '@/lib/notifications';

export default class InlineGeneration {
  static get isInline() {
    return true;
  }
  ...
  async surround(range) {
    ...
    try {
      const replace = range.cloneContents();
      ...
      fragment.append(res.data.replaced);
  ...
  checkState(selection) {
    ...
    if (parent) {
      this.fullText = parent.textContent;
    }
  }
}

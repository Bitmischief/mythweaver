<template>
  <div class="flex h-screen overflow-y-hidden">
    <div class="relative hidden md:flex md:w-[50%]">
      <div
    ...
    <div
      class="flex flex-col bg-gradient-to-b from-surface from-70% via-pink-500/5 via-95% to-pink-500/5 p-4 md:w-[50%] md:justify-center"
    >

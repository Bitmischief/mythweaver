 ...
 *
 * @checksum - e220c12d84d0e749800284598f5bd680a7788cc140e0a1543787a73f9eab4dd1
 * @variables - radius=rounded-lg,accentColor=fuchsia,colorTemperature=slate,spacing=2,scale=sm,inputShadow=shadow-md,baseColorShade=500,borderShadeLightMode=400,borderShadeDarkMode=700,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:box__decorator': {
    ...
    'bg-white': false,
    'ring-fuchsia-400': true,
    'peer-checked:border-fuchsia-500': true,
    relative: true,
    block: true,
    'text-base': true,
    'w-[1em]': true,
    ...
    'peer-checked:text-fuchsia-500': true,
    ...
    'dark:ring-offset-fuchsia-400': true,
    'dark:peer-focus-visible:ring-1': true,
    'dark:peer-disabled:bg-slate-600/50': true,
    'dark:peer-checked:bg-fuchsia-800': true,
    'dark:peer-checked:text-fuchsia-300': true,
  },
  ...
  'family:text__inner': {
    ...
    'rounded-lg': true,
    border: true,
    'border-surface-3': true,
    'bg-white': false,
    'focus-within:ring-1': true,
    'focus-within:!ring-fuchsia-400': true,
    'focus-within:!border-fuchsia-400': true,
  ...
  'family:dropdown__listbox': {
    ...
    'group-data-[overscroll]:dark:border-slate-700': true,
  },
  'family:dropdown__listitem': {
    ...
    'data-[is-active]:before:ring-fuchsia-400': true,
  ...
  'family:dropdown__loadMoreInner': {
    ...
    'justify-center': true,
    '[&>span]:mr-2': true,
    'hover:text-fuchsia-500': true,
    'cursor-pointer': true,
    'dark:text-slate-200': true,
    'dark:hover:text-fuchsia-400': true,
  },
  ...
  'family:dropdown__tagWrapper': {
    ...
    'data-[active-selection=true]:ring-fuchsia-400': true,
  },
  ...
  'family:dropdown__tag': {
    ...
    'group-data-[active-selection=true]/tag:bg-fuchsia-300': true,
  ...
  'family:dropdown__emptyMessage': {
    ...
    'aria-selected:bg-fuchsia-500': true,
  },
  button__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  color__inner: {
    ...
    'dark:group-data-[prefix-icon]:border-slate-700': true,
    'dark:group-data-[suffix-icon]:border-slate-700': true,
  },
  color__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  file__fileRemove: {
    ...
    'peer-data-[has-multiple]:text-fuchsia-500': true,
  ...
  form__messageLink: {
    ...
    'group-[]/summary:ring-fuchsia-500': true,
  },
  month__input: {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  range__input: {
    ...
    '[&::-webkit-slider-thumb]:focus:!ring-fuchsia-400': true,
    '[&::-webkit-slider-thumb]:focus:ring-offset-2': true,
    '[&::-webkit-slider-thumb]:shadow-md': true,
    'dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-slate-700': true,
    ...
    'dark:[&::-moz-range-track]:bg-slate-600/50': true,
    ...
    '[&::-moz-range-thumb]:bg-fuchsia-500': true,
    ...
    '[&::-moz-range-thumb]:focus:!ring-fuchsia-400': true,
  ...
  select__option: {
    ...
    'dark:group-data-[multiple]:focus:bg-fuchsia-700': true,
    'dark:group-data-[multiple]:checked:bg-fuchsia-700': true,
  },
  select__prefixIcon: {
    flex: true,
    'items-center': true,
  ...
  submit__input: {
    ...
    'active:bg-fuchsia-600': true,
    'hover:bg-fuchsia-600': true,
  ...
  autocomplete__selectionWrapper: {
    ...
    'dark:group-data-[multiple]:border-slate-700': true,
  ...
  colorpicker__control: {
    ...
    'focus-visible:ring-fuchsia-400': true,
  },
  ...
  colorpicker__fieldGroup: {
    ...
    '[&>input:focus]:ring-fuchsia-500': true,
    '[&>input:focus]:border-fuchsia-500': true,
  ...
  colorpicker__swatch: {
    ...
    'data-[active=true]:after:bg-white': false,
    ...
    '[&>canvas:focus-visible]:ring-fuchsia-400': true,
  ...
  datepicker__month: {
    ...
    'focus:outline-fuchsia-500': true,
    'focus:outline-offset-2': true,
    'focus:bg-white': false,
  ...
  datepicker__dayCell: {
    ...
    'dark:bg-slate-600': true,
    'dark:text-slate-300': true,
    'dark:aria-selected:bg-fuchsia-500': true,
    'dark:aria-selected:text-white': true,
    'dark:focus:outline-fuchsia-500': true,
  ...
  datepicker__timeInput: {
    ...
    'p-1.5': true,
    'my-2.5': true,
    'focus-visible:outline-fuchsia-500': true,
    'dark:text-slate-300': true,
    'dark:bg-transparent': true,
    'dark:border-slate-700': true,
  },
  ...
  datepicker__dayButton: {
    ...
    'dark:text-slate-300': true,
    'dark:border-slate-700': true,
    'dark:hover:border-fuchsia-400': true,
  },
  ...
  datepicker__calendarIcon: {
    'text-slate-600': true,
    'focus-visible:text-fuchsia-500': true,
    flex: true,
    'w-[1em]': true,
    'grow-0': true,
    'shrink-0': true,
  ...
  slider__mark: {
    ...
    '-translate-y-1/2': true,
    'bg-slate-400': true,
    'data-[active=true]:bg-white': false,
  },
  slider__markLabel: {
    absolute: true,
  ...
  slider__tooltip: {
    ...
    'after:border-t-fuchsia-500': true,
  ...
  slider__minValue: {
    ...
    'dark:[&>div>div::after]:bg-slate-700': true,
  },
  slider__maxValue: {
    grow: true,
    '!max-w-[45%]': true,
  ...
  toggle__track: {
    ...
    'transition-all': true,
    'bg-slate-400': true,
    'peer-checked:bg-fuchsia-500': true,
    ...
    shadow: true,
    'peer-focus-visible:ring-2': true,
    'peer-focus-visible:ring-fuchsia-400': true,
  ...
  togglebuttons__input: {
    ...
    'dark:text-fuchsia-500': true,
    'aria-[pressed=true]:bg-fuchsia-500': true,
    'aria-[pressed=true]:text-white': true,
    'dark:aria-[pressed=true]:bg-fuchsia-500': true,
    ...
    'group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-fuchsia-500':
      true,
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-fuchsia-500':
      true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-fuchsia-500':
      true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-fuchsia-500':
      true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-fuchsia-500':
      true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-fuchsia-500':
      true,
    ...
    'group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-fuchsia-500':
      true,
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-fuchsia-500':
      true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-fuchsia-500':
      true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-fuchsia-500':
      true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-fuchsia-500':
      true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-fuchsia-500':
      true,
  },
  transferlist__outer: {
    group: true,
    ...
    'text-sm': true,
    'max-w-none': true,
    '[&_.dnd-placeholder]:bg-fuchsia-500': true,
  ...
  transferlist__transferlist: {
    ...
    '[&:has(:focus-visible)]:ring-fuchsia-400': true,
    'dark:border-slate-800': true,
  ...
  transferlist__transferlistListItem: {
    ...
    'dark:bg-slate-800': true,
    'dark:text-slate-300': true,
    'dark:data-[is-active=true]:bg-fuchsia-800': true,
    'dark:aria-selected:bg-fuchsia-800': true,
  ...
  'multi-step__tabs': {
    ...
    'dark:group-data-[tab-style="tab"]/wrapper:border-slate-800': true,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style="tab"]/wrapper:shadow-[inset_0_-0.5em_0.5em_-0.5em_rgba(0,0,0,0.1)]':
      true,
    'group-data-[tab-style="tab"]/wrapper:data-[active=true]:bg-white': false,
    ...
    'group-data-[tab-style="progress"]/wrapper:before:bg-white': false,
    'group-data-[tab-style="progress"]/wrapper:before:z-10': true,
    'dark:group-data-[tab-style="progress"]/wrapper:before:border-slate-800': true,
    ...
    'group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-fuchsia-500':
      true,
    'group-data-[tab-style="progress"]/wrapper:last:after:hidden': true,
    'dark:group-data-[tab-style="progress"]/wrapper:after:bg-slate-800': true,
    'dark:group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-fuchsia-500':
      true,
  },
  ...
  'multi-step__badge': {
    ...
    'text-white': true,
    'rounded-full': true,
    'group-data-[valid=true]/tab:bg-fuchsia-500': true,

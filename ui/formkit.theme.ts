...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "togglebuttons__input": {
    ...
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-fuchsia-500": true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-fuchsia-500": true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-fuchsia-500": true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-fuchsia-500": true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-fuchsia-500": true,
    ...
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-fuchsia-500": true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-fuchsia-500": true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-fuchsia-500": true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-fuchsia-500": true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-fuchsia-500": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=\"progress\"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-fuchsia-500": true,
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-fuchsia-500": true
  },

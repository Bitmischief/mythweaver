export default {
  ...
  global: {
    ...
    input: 'appearance-none bg-neutral-800 rounded-[10px]',
    label: 'block mb-1 font-bold text-sm',
    legend: 'font-bold text-sm',
    loaderIcon: 'inline-flex items-center w-4 text-gray-600 animate-spin',
    message: 'text-red-400 mb-1 text-xs',
  ...
  'family:button': {
    input:
      '$reset flex self-center rounded-md bg-gradient-to-r from-fuchsia-500 to-blue-400 px-4 py-3 transition-all hover:scale-110',
    wrapper: 'mb-1',
  ...
  'family:text': {
    inner:
      'flex items-center max-w-md focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
    input: 'w-full px-3 py-2',
  },
  'family:date': {
    inner:
  ...
  textarea: {
    inner:
      'flex rounded mb-1 w-full focus-within:ring-blue-500 [&>label:first-child]:focus-within:text-blue-500',
    input: 'block w-full h-32 px-3 w-full py-3 border-none',
  },
